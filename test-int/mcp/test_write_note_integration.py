...
from memopad.schemas.project_info import ProjectItem
...
async def test_write_note_project_path_validation(mcp_server, app, test_project):
    ...
    the project name and path happen to be the same. The fix in src/memopad/schemas/project_info.py:186
