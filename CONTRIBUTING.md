# Contributing to MemoPad

Thank you for considering contributing to MemoPad! This document outlines the process for contributing to the
...
2. **Install Dependencies**:
   ...
   > **Note**: MemoPad uses [just](https://just.systems) as a modern command runner. Install with `brew install just` or `cargo install just`.
...
MemoPad uses two test directories with unified coverage reporting:
...
MemoPad uses automatic versioning based on git tags with `uv-dynamic-versioning`. Here's how releases work:
...
- Users install with: `pip install memopad --pre --force-reinstall`
...
3. Users install with: `pip install memopad --pre`
...
2. GitHub Actions automatically:
   ...
   - Publishes to PyPI
3. Users install with: `pip install memopad`
...
Your contributions help make MemoPad better. We appreciate your time and effort!