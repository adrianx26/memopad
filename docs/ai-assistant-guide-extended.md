# AI Assistant Guide for MemoPad - Extended Edition

**This is the comprehensive guide for AI assistants using MemoPad through MCP.**
...
1. [Understanding MemoPad](#understanding-memopad)
...
## Understanding MemoPad

**Core Concept**: MemoPad is a local-first knowledge management system that creates a semantic knowledge graph from markdown files. It enables persistent, structured knowledge that survives across AI sessions.
...
MemoPad's semantic knowledge graph - observations, relations, context building - is designed to help you (the AI assistant) provide better help to humans. You use the graph structure to:
...
**Capturing conversations in MemoPad enables long-term context and knowledge accumulation.**
...
AI: "Would you like me to save our discussion about API authentication
     to MemoPad? This will help us continue this conversation later
     and build on what we've learned."

User: "Yes, please"

AI: [Saves to MemoPad]
    "I've saved our discussion to MemoPad as 'API Authentication Discussion'."
```
