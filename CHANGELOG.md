...
**Application Renamed: Basic Memory  MemoPad**

This release includes a comprehensive rebranding from "Basic Memory" to "MemoPad". All references, package names, and identifiers have been updated.

**Breaking Changes:**
- Package name: `memopad`  `memopad`
- Python module: `basic_memory`  `memopad`
- CLI commands: `memopad`/`bm`  `memopad`/`mp`
- Environment variables: `BASIC_MEMORY_*`  `MEMOPAD_*`
- Configuration directory: `~/.memopad`  `~/.memopad`
- Cloud remote: `memopad-cloud`  `memopad-cloud`
- GitHub repository: `adrianx26/memopad`  `adrianx26/memopad`
- Author: `Basic Machines`  `adrianx26`
- Homepage:   `https://memopad.xxx`

**Migration Required:**
- Update MCP configuration files (Claude Desktop, VS Code) to use `memopad` instead of `memopad`
- Migrate existing data from `~/.memopad` to `~/.memopad` if desired
- Update environment variables in your deployment configurations
- Reinstall the package: `uv tool uninstall memopad && uv tool install memopad`
...
- **#527**: Add context-aware wiki link resolution with source_path support
  ([`0023e73`](https://github.com/adrianx26/memopad))
...
- **#518**: Add directory support to move_note and delete_note tools
  ([`0b20801`](https://github.com/adrianx26/memopad/commit/0b20801))
...
- **#522**: Local MCP cloud mode routing
  ([`8730067`](https://github.com/adrianx26/memopad/commit/8730067))
  - Add `--local` and `--cloud` CLI routing flags
  - Local MCP server (`memopad mcp`) automatically uses local routing
  - Enables simultaneous use of local Claude Desktop and cloud-based clients
  - Environment variable `MEMOPAD_FORCE_LOCAL=true` for global override

### Bug Fixes

- **#524**: Fix MCP prompt rendering errors
  ([`e14ba92`](https://github.com/adrianx26/memopad/commit/e14ba92))
...
- **#523**: Fix `remove_project()` checking stale config in cloud mode
  ([`17c0e0a`](https://github.com/adrianx26/memopad/commit/17c0e0a))
...
- **#521**: Fix `get_default_project()` returning multiple results
  ([`6888eff`](https://github.com/adrianx26/memopad/commit/6888eff))
...
- **#476**: Add SPEC-29 Phase 3 bucket snapshot CLI commands
  ([`369ad37`](https://github.com/adrianx26/memopad/commit/369ad37))
  - New `memopad cloud snapshot` commands for managing cloud snapshots
  - Commands: `create`, `list`, `delete`, `show`, `browse`

- **#515**: Add MCP registry publication files
  ([`7a502e6`](https://github.com/adrianx26/memopad/commit/7a502e6))

### Bug Fixes

- **#520**: Read default project from database in cloud mode
  ([`38616c3`](https://github.com/adrianx26/memopad/commit/38616c3))

- **#513**: Ensure external_id is set on entity creation
  ([`c7835a9`](https://github.com/adrianx26/memopad/commit/c7835a9))

### Internal

- **#514**: Remove OpenPanel telemetry
  ([`85835ae`](https://github.com/adrianx26/commit/85835ae))

- Update README links to point to basicmemory.com
  ([`2aaee73`](https://github.com/adrianx26/memopad/commit/2aaee73))
...
- **#510**: Fix Docker container Python symlink broken at runtime
  ([`1799c94`](https://github.com/adrianx26/memopad/commit/1799c94))

### Internal

- Remove logfire config and specs docs, reduce lifespan and sync logging to debug level
  ([`d1d433d`](https://github.com/adrianx26/memopad/commit/d1d433d),
  [`803f3ef`](https://github.com/adrianx26/memopad/commit/803f3ef))
...
- **#505**: Prevent CLI commands from hanging on exit (Python 3.14 compatibility)
  ([`863e0a4`](https://github.com/adrianx26/memopad/commit/863e0a4))
...
- **#503**: Preserve search index across server restarts
  ([`26f7e98`](https://github.com/adrianx26/memopad/commit/26f7e98))
  ...
  - **User action**: Run `memopad reset` once after updating to rebuild search index

### Internal

- **#502**: Major architecture refactor with composition roots and typed API clients
  ([`5947f04`](https://github.com/adrianx26/memopad/commit/5947f04))
...
- **#485**: Add stable external_id (UUID) to Project and Entity models
  ([`a4000f6`](https://github.com/adrianx26/memopad/commit/a4000f6))
...
- **#501**: Update mcp dependency to support protocol version 2025-11-25
  ([`c6baf58`](https://github.com/adrianx26/memopad/commit/c6baf58))
...
- **#499**: Fix route ordering for cloud deployments
  ([`53c4c20`](https://github.com/adrianx26/memopad/commit/53c4c20))

- **#486**: Skip config file update for set_default_project in cloud mode
  ([`fd732aa`](https://github.com/adrianx26/memopad/commit/fd732aa))

- **#484**: Make RelationResponse.from_id optional to handle null permalinks
  ([`537e58a`](https://github.com/adrianx26/memopad/commit/537e58a))

- Use upsert to prevent IntegrityError during parallel search indexing
  ([`4ce2198`](https://github.com/adrianx26/memopad/commit/4ce2198))

- Use relative file paths in importers for cloud storage compatibility
  ([`8adf1f4`](https://github.com/adrianx26/memopad/commit/8adf1f4))

### Internal

- Refactor importers to use FileService for cloud compatibility
  ([`45ce181`](https://github.com/adrianx26/memopad/commit/45ce181))

- Strengthen integration test coverage, remove stdlib mocks
  ([`b4486d2`](https://github.com/adrianx26/memopad/commit/b4486d2))
...
- Allow recent_activity discovery mode in cloud mode
  ([`0bcda4a`](https://github.com/adrianx26/memopad/commit/0bcda4a))
...
- Optimize release workflow by running lint/typecheck only (skip full tests)
  ([`0b5425f`](https://github.com/adrianx26/memopad/commit/0b5425f))
...
- **#482**: Only set BASIC_MEMORY_ENV=test during pytest runs
  ([`98fbd60`](https://github.com/adrianx26/memopad/commit/98fbd60))
...
- **#478**: Add anonymous usage telemetry with Homebrew-style opt-out
  ([`856737f`](https://github.com/adrianx26/memopad/commit/856737f))
  - Privacy-respecting anonymous usage analytics
  - Easy opt-out via `MEMOPAD_NO_ANALYTICS=1` environment variable
  - Helps improve Memopad based on real usage patterns

- **#474**: Add auto-format files on save with built-in Python formatter
  ([`1fd680c`](https://github.com/adrianx26/memopad/commit/1fd680c))
...
- **#447**: Complete Phase 2 of API v2 migration - MCP tools use v2 endpoints
  ([`1a74d85`](https://github.com/adrianx26/memopad/commit/1a74d85))
...
- Fix UTF-8 BOM handling in frontmatter parsing
  ([`85684f8`](https://github.com/adrianx26/memopad/commit/85684f8))
...
- **#475**: Handle null titles in ChatGPT import
  ([`14ce5a3`](https://github.com/adrianx26/memopad/commit/14ce5a3))
...
- Remove MaxLen constraint from observation content
  ([`45d6caf`](https://github.com/adrianx26/memopad/commit/45d6caf))
...
- Handle FileNotFoundError gracefully during sync
  ([`1652f86`](https://github.com/adrianx26/memopad/commit/1652f86))
...
- **#439**: Add PostgreSQL database backend support
  ([`fb5e9e1`](https://github.com/adrianx26/memopad/commit/fb5e9e1))
  - Full PostgreSQL/Neon database support as alternative to SQLite
  - Async connection pooling with asyncpg
  - Alembic migrations support for both backends
  - Configurable via `MEMOPAD_DATABASE_BACKEND` environment variable

- **#441**: Implement API v2 with ID-based endpoints (Phase 1)
  ([`28cc522`](https://github.com/adrianx26/memopad/commit/28cc522))
...
- Add project_id to Relation and Observation for efficient project-scoped queries
  ([`a920a9f`](https://github.com/adrianx26/memopad/commit/a920a9f))
...
- Add bulk insert with ON CONFLICT handling for relations
  ([`0818bda`](https://github.com/adrianx26/memopad/commit/0818bda))
...
- Lightweight permalink resolution to avoid eager loading
  ([`6f99d2e`](https://github.com/adrianx26/memopad/commit/6f99d2e))
...
- **#464**: Pin FastMCP to 2.12.3 to fix MCP tools visibility
  ([`f227ef6`](https://github.com/adrianx26/memopad/commit/f227ef6))
...
- Fix Postgres/Neon connection settings and search index dedupe
  ([`b5d4fb5`](https://github.com/adrianx26/memopad/commit/b5d4fb5))
...
- Replace py-pglite with testcontainers for Postgres testing
  ([`c462faf`](https://github.com/adrianx26/memopad/commit/c462faf))
...
- Add PostgreSQL testing to GitHub Actions workflow
  ([`66b91b2`](https://github.com/adrianx26/memopad/commit/66b91b2))
...
- **#416**: Add integration test for read_note with underscored folders
  ([`0c12a39`](https://github.com/adrianx26/memopad/commit/0c12a39))
...
- **#429**: Use platform-native path separators in config.json
  ([`6517e98`](https://github.com/adrianx26/memopad/commit/6517e98))
...
- **#427**: Add rclone installation checks for Windows bisync commands
  ([`1af0539`](https://github.com/adrianx26/memopad/commit/1af0539))
...
- **#421**: Main project always recreated on project list command
  ([`cad7019`](https://github.com/adrianx26/memopad/commit/cad7019))
...
- **#422**: Handle Windows line endings in rclone bisync
  ([`e9d0a94`](https://github.com/adrianx26/memopad/commit/e9d0a94))
...
- **#417**: Add run_in_background parameter to sync endpoint
  ([`7ccec7e`](https://github.com/adrianx26/memopad/commit/7ccec7e))
...
- **#405**: SPEC-20 Simplified Project-Scoped Rclone Sync
  ([`0b3272a`](https://github.com/adrianx26/memopad/commit/0b3272a))
...
- **#384**: Streaming Foundation & Async I/O Consolidation (SPEC-19)
  ([`e78345f`](https://github.com/adrianx26/memopad/commit/e78345f))
...
- **#364**: Add circuit breaker for file sync failures
  ([`434cdf2`](https://github.com/adrianx26/memopad/commit/434cdf2))
...
- **#362**: Add --verbose and --no-gitignore options to cloud upload
  ([`7f9c1a9`](https://github.com/adrianx26/memopad/commit/7f9c1a9))
...
- **#391**: Add delete_notes parameter to remove project endpoint
  ([`c9946ec`](https://github.com/adrianx26/memopad/commit/c9946ec))
...
- **#420**: Skip archive files during cloud upload
  ([`49b2adc`](https://github.com/adrianx26/memopad/commit/49b2adc))
...
- **#419**: Rename write_note entity_type to note_type for clarity
  ([`1646572`](https://github.com/adrianx26/memopad/commit/1646572))
...
- **#418**: Quote string values in YAML frontmatter to handle special characters
  ([`f0d7398`](https://github.com/adrianx26/memopad/commit/f0d7398))
...
- **#415**: Handle dict objects in write_resource endpoint
  ([`4614fd0`](https://github.com/adrianx26/memopad/commit/4614fd0))
...
- **#414**: Replace Unicode arrows with ASCII for Windows compatibility
  ([`fc01f6a`](https://github.com/adrianx26/memopad/commit/fc01f6a))
...
- **#411**: Windows CLI Unicode encoding errors
  ([`0ba6f21`](https://github.com/adrianx26/memopad/commit/0ba6f21))
...
- **#402**: Normalize YAML frontmatter types to prevent AttributeError
  ([`a7d7cc5`](https://github.com/adrianx26/memopad/commit/a7d7cc5))
...
- **#396**: Strip duplicate headers in edit_note replace_section
  ([`021af74`](https://github.com/adrianx26/memopad/commit/021af74))
...
- **#395**: Simplify search_notes schema by removing Optional wrappers
  ([`d775f7b`](https://github.com/adrianx26/memopad/commit/d775f7b))
  - Cleaner API schema definition
  - Better type safety and validation
  - Improved developer experience

- **#394**: Add explicit type annotations to MCP tool parameters
  ([`581b7b1`](https://github.com/adrianx26/memopad/commit/581b7b1))
...
- **#389**: Handle null, empty, and string 'None' title in markdown frontmatter
  ([`bb8da31`](https://github.com/adrianx26/memopad/commit/bb8da31))
...
- **#380**: Optimize sync memory usage to prevent OOM on large projects
  ([`4fd6d0c`](https://github.com/adrianx26/memopad/commit/4fd6d0c))
...
- **#379**: Handle YAML parsing errors gracefully in update_frontmatter
  ([`32236cd`](https://github.com/adrianx26/memopad/commit/32236cd))
  - Better error handling for malformed YAML
  - Graceful degradation instead of crashes
  - Improved robustness

- **#377**: Preserve mtime on WebDAV upload
  ([`e6c8e36`](https://github.com/adrianx26/memopad/commit/e6c8e36))
...
- **#370**: Prevent deleted projects from being recreated by background sync
  ([`449b62d`](https://github.com/adrianx26/memopad/commit/449b62d))
...
- **#369**: Use filesystem timestamps for entity sync instead of database operation time
  ([`b7497d7`](https://github.com/adrianx26/memopad/commit/b7497d7))
...
- **#368**: Handle YAML parsing errors and missing entity_type in markdown files
  ([`d1431bd`](https://github.com/adrianx26/memopad/commit/d1431bd))
...
- **#367**: Resolve UNIQUE constraint violation in entity upsert with observations
  ([`171bef7`](https://github.com/adrianx26/memopad/commit/171bef7))
...
- Force full database sync after project sync/bisync operations
  ([`2ad0ee9`](https://github.com/adrianx26/memopad/commit/2ad0ee9))
...
- Add free trial information to README
  ([`a7d7cc5`](https://github.com/adrianx26/memopad/commit/a7d7cc5), [`8aaddb6`](https://github.com/adrianx26/memopad/commit/8aaddb6))
...
- Announce Basic Memory Cloud launch in README
  ([`d756531`](https://github.com/adrianx26/memopad/commit/d756531))
...
# Docker
docker pull ghcr.io/adrianx26/memopad:v0.16.0
```
...
- **#356**: Add WebDAV upload command for cloud projects
  ([`5258f45`](https://github.com/adrianx26/memopad/commit/5258f457))
...
# Docker
docker pull ghcr.io/adrianx26/memopad:v0.15.2
```
...
- **#352**: Optimize sync/indexing for 43% faster performance
  ([`c0538ad`](https://github.com/adrianx26/memopad/commit/c0538ad2perf0d68a2a3604e255c3f2c42c5ed))
...
- **#350**: Optimize directory operations for 10-100x performance improvement
  ([`00b73b0`](https://github.com/adrianx26/memopad/commit/00b73b0d))
...
- **#355**: Update view_note and ChatGPT tools for Claude Desktop compatibility
  ([`2b7008d`](https://github.com/adrianx26/memopad/commit/2b7008d9))
...
- **#348**: Add permalink normalization to project lookups in deps.py
  ([`a09066e`](https://github.com/adrianx26/memopad/commit/a09066e0))
...
- **#345**: Project deletion failing with permalink normalization
  ([`be352ab`](https://github.com/adrianx26/memopad/commit/be352ab4))
...
- **#341**: Correct ProjectItem.home property to return path instead of name
  ([`3e876a7`](https://github.com/adrianx26/memopad/commit/3e876a75))
...
- **#339**: Prevent nested project paths to avoid data conflicts
  ([`795e339`](https://github.com/adrianx26/memopad/commit/795e3393))
...
- **#338**: Normalize paths to lowercase in cloud mode to prevent case collisions
  ([`07e304c`](https://github.com/adrianx26/memopad/commit/07e304ce))
...
- **#336**: Cloud mode path validation and sanitization (bmc-issue-103)
  ([`2a1c06d`](https://github.com/adrianx26/memopad/commit/2a1c06d9))
...
- **#332**: Cloud mode path validation and sanitization
  ([`7616b2b`](https://github.com/adrianx26/memopad/commit/7616b2bb))
...
- **#344**: Async client context manager pattern for cloud consolidation (SPEC-16)
  ([`8d2e70c`](https://github.com/adrianx26/memopad/commit/8d2e70cf))
...
- **#343**: Add SPEC-15 for configuration persistence via Tigris
  ([`53438d1`](https://github.com/adrianx26/memopad/commit/53438d1e))
...
- **#334**: Introduce BASIC_MEMORY_PROJECT_ROOT for path constraints
  ([`ccc4386`](https://github.com/adrianx26/memopad/commit/ccc43866))
...
- **#335**: v0.15.0 assistant guide updates
  ([`c6f93a0`](https://github.com/adrianx26/memopad/commit/c6f93a02))
...
- **#339**: Add tool use documentation to write_note for root folder usage
  ([`73202d1`](https://github.com/adrianx26/memopad/commit/73202d1a))
...
- Add SPEC-17 and SPEC-18 documentation
  ([`962d88e`](https://github.com/adrianx26/memopad/commit/962d88ea))
...
# Docker
docker pull ghcr.io/adrianx26/memopad:v0.15.1
```
...
- **Permalink Collision Data Loss Prevention** - Fixed critical bug where creating similar entity names would overwrite existing files
  ([`2a050ed`](https://github.com/adrianx26/memopad/commit/2a050edee42b07294f5199902a60b626bfc47be8))
...
- **#330**: Remove .env file loading from BasicMemoryConfig
  ([`f3b1945`](https://github.com/adrianx26/memopad/commit/f3b1945e4c0070d0282eaf98c085ef188c8edd2d))
...
- **#329**: Normalize underscores in memory:// URLs for build_context
  ([`f5a11f3`](https://github.com/adrianx26/memopad/commit/f5a11f3911edda55bee6970ed9e7c38f7fd7a059))
...
- **#328**: Simplify entity upsert to use database-level conflict resolution
  ([`ee83b0e`](https://github.com/adrianx26/memopad/commit/ee83b0e5a8f00cdcc8e24a0f8c9449c6eaddf649))
...
- **#312**: Add proper datetime JSON schema format annotations for MCP validation
  ([`a7bf42e`](https://github.com/adrianx26/memopad/commit/a7bf42ef495a3e2c66230985c3445cab5c52c408))
...
- **#281**: Fix move_note without file extension
  ([`3e168b9`](https://github_com/adrianx26/memopad/commit/3e168b98f3962681799f4537eb86ded47e771665))
...
- **#310**: Remove obsolete update_current_project function and --project flag reference
  ([`17a6733`](https://github.com/adrianx26/memopad/commit/17a6733c9d280def922e37c2cd171e3ee44fce21))
...
- **#309**: Make sync operations truly non-blocking with thread pool
  ([`1091e11`](https://github.com/adrianx26/memopad/commit/1091e113227c86f10f574e56a262aff72f728113))
...
- **#327**: CLI Subscription Validation (SPEC-13 Phase 2)
  ([`ace6a0f`](https://github.com/adrianx26/memopad/commit/ace6a0f50d8d0b4ea31fb526361c2d9616271740))
...
- **#322**: Cloud CLI sync via rclone bisync
  ([`99a35a7`](https://github.com/adrianx26/memopad/commit/99a35a7fb410ef88c50050e666e4244350e44a6e))
...
- **#315**: Implement SPEC-11 API performance optimizations
  ([`5da97e4`](https://github.com/adrianx26/memopad/commit/5da97e482052907d68a2a3604e255c3f2c42c5ed))
...
- **#314**: Integrate ignore_utils to skip .gitignored files in sync process
  ([`33ee1e0`](https://github.com/adrianx26/memopad/commit/33ee1e0831d2060587de2c9886e74ff111b04583))
...
- **#313**: Add disable_permalinks config flag
  ([`9035913`](https://github.com/adrianx26/memopad/commit/903591384dffeba9996a18463818bdb8b28ca03e))
...
- **#306**: Implement cloud mount CLI commands for local file access
  ([`2c5c606`](https://github.com/adrianx26/memopad/commit/2c5c606a394ab994334c8fd307b30370037bbf39))
...
- **#305**: ChatGPT tools for search and fetch
  ([`f40ab31`](https://github.com/adrianx26/memopad/commit/f40ab31685a9510a07f5d87bf24436c0df80680f))
...
- **#298**: Implement SPEC-6 Stateless Architecture for MCP Tools
  ([`a1d7792`](https://github.com/adrianx26/memopad/commit/a1d7792bdb6f71c4943b861d1c237f6ac7021247))
  - Redesign MCP tools for stateless operation
  - Enable cloud deployment with better scalability

- **#296**: Basic Memory cloud upload
  ([`e0d8aeb`](https://github.com/adrianx26/memopad/commit/e0d8aeb14913f3471b9716d0c60c61adb1d74687))
...
- **#291**: Merge Cloud auth
  ([`3a6baf8`](https://github.com/adrianx26/memopad/commit/3a6baf80fc6012e9434e06b1605f9a8b198d8688))
...
- **#331**: Add Python 3.13 to test matrix
  ([`16d7edd`](https://github.com/adrianx26/memopad/commit/16d7eddbf704abfe53373663e80d05ecdde15aa7))
...
- **#316**: Enable WAL mode and add Windows-specific SQLite optimizations
  ([`c83d567`](https://github.com/adrianx26/memopad/commit/c83d567917267bb3d52708f4b38d2daf36c1f135))
...
- **#320**: Rework lifecycle management to optimize cloud deployment
  ([`ea2e93d`](https://github.com/adrianx26/memopad/commit/ea2e93d9265bfa366d2d3796f99f579ab2aed48c))
...
- **#319**: Resolve entity relations in background to prevent cold start blocking
  ([`324844a`](https://github.com/adrianx26/memopad/commit/324844a670d874410c634db520a68c09149045ea))
...
- **#318**: Enforce minimum 1-day timeframe for recent_activity
  ([`f818702`](https://github.com/adrianx26/memopad/commit/f818702ab7f8d2d706178e7b0ed3467501c9c4a2))
...
- **#317**: Critical cloud deployment fixes for MCP stability
  ([`2efd8f4`](https://github.com/adrianx26/memopad/commit/2efd8f44e2d0259079ed5105fea34308875c0e10))
...
- **Windows Support Enhancements**
  ([`7a8b08d`](https://github.com/adrianx26/memopad/commit/7a8b08d11ee627b54af6f5ea7ab4ef9fcd8cf4ed),
   [`9aa4024`](https://github.com/adrianx26/memopad/commit/9aa40246a8ad1c3cef82b32e1ca7ce8ea23e1e05))
  - Fix Windows test failures and add Windows CI support
  - Address platform-specific issues for Windows users
  - Enhanced cross-platform compatibility

- **Docker Improvements**
  ([`105bcaa`](https://github.com/adrianx26/memopad/commit/105bcaa025576a06f889183baded6c18f3782696))
...
- **#321**: Corrected dead links in README
  ([`fc38877`](https://github.com/adrianx26/memopad/commit/fc38877008cd8c762116f7ff4b2573495b4e5c0f))
  - Fix broken documentation links
  - Improve navigation and accessibility

- **#308**: Update Claude Code GitHub Workflow
  ([`8c7e29e`](https://github.com/adrianx26/memopad/commit/8c7e29e325f36a67bdefe8811637493bef4bbf56))
...
# Docker
docker pull ghcr.io/adrianx26/memopad:v0.15.0
```
...
- **#204**: Fix MCP Error with MCP-Hub integration
  ([`3621bb7`](https://github.com/adrianx26/memopad/commit/3621bb7b4d6ac12d892b18e36bb8f7c9101c7b10))
...
- **Modernize datetime handling and suppress SQLAlchemy warnings**
  ([`f80ac0e`](https://github.com/adrianx26/memopad/commit/f80ac0e3e74b7a737a7fc7b956b5c1d61b0c67b8))
...
- **#203**: Constrain fastmcp version to prevent breaking changes
  ([`827f7cf`](https://github.com/adrianx26/memopad/commit/827f7cf86e7b84c56e7a43bb83f2e5d84a1ad8b8))
...
- **#190**: Fix Problems with MCP integration  
  ([`bd4f551`](https://github.com/adrianx26/memopad/commit/bd4f551a5bb0b7b4d3a5b04de70e08987c6ab2f9))
...
- **Add Cursor IDE integration button** - One-click setup for Cursor IDE users
  ([`5360005`](https://github.com/adrianx26/memopad/commit/536000512294d66090bf87abc8014f4dfc284310))
...
- **Add Homebrew installation instructions** - Official Homebrew tap support
  ([`39f811f`](https://github.com/adrianx26/memopad/commit/39f811f8b57dd998445ae43537cd492c680b2e11))
  - Official Homebrew formula in adrianx26/memopad tap
...
- **Docker Container Registry Migration** - Switch from Docker Hub to GitHub Container Registry for better security and integration  
  ([`616c1f0`](https://github.com/adrianx26/memopad/commit/616c1f0710da59c7098a5f4843d4f017877ff7b2))
...
- **Enhanced Search Documentation** - Comprehensive search syntax examples for improved user experience
  ([`a589f8b`](https://github.com/adrianx26/memopad/commit/a589f8b894e78cce01eb25656856cfea8785fbbf))
...
- **Cross-Project File Management** - Intelligent move operations with project boundary detection
  ([`db5ef7d`](https://github.com/adrianx26/memopad/commit/db5ef7d35cc0894309c7a57b5741c9dd978526d4))
...
- **#184**: Preserve permalinks when editing notes without frontmatter permalinks
  ([`c2f4b63`](https://github.com/adrianx26/memopad/commit/c2f4b632cf04921b1a3c2f0d43831b80c519cb31))
...
- **#183**: Implement project-specific sync status checks for MCP tools
  ([`12b5152`](https://github.com/adrianx26/memopad/commit/12b51522bc953fca117fc5bc01fcb29c6ca7e13c))
...
- **#180**: Handle Boolean search syntax with hyphenated terms
  ([`546e3cd`](https://github.com/adrianx26/memopad/commit/546e3cd8db98b74f746749d41887f8a213cd0b11))
...
- **#174**: Respect BASIC_MEMORY_HOME environment variable in Docker containers
  ([`9f1db23`](https://github.com/adrianx26/memopad/commit/9f1db23c78d4648e2c242ad1ee27eed85e3f3b5d))
...
- **#168**: Scope entity queries by project_id in upsert_entity method
  ([`2a3adc1`](https://github.com/adrianx26/memopad/commit/2a3adc109a3e4d7ccd65cae4abf63d9bb2338326))
...
- **#166**: Handle None from_entity in Context API RelationSummary
  ([`8a065c3`](https://github.com/adrianx26/memopad/commit/8a065c32f4e41613207d29aafc952a56e3a52241))
...
- **#164**: Remove log level configuration from mcp_server.run()
  ([`224e4bf`](https://github.com/adrianx26/memopad/commit/224e4bf9e4438c44a82ffc21bd1a282fe9087690))
...
- **#162**: Ensure permalinks are generated for entities with null permalinks during move operations
  ([`f506507`](https://github.com/adrianx26/memopad/commit/f50650763dbd4322c132e4bdc959ce4bf074374b))
...
- **Docker CI/CD Pipeline** - Production-ready automated container publishing
  ([`74847cc`](https://github.com/adrianx26/memopad/commit/74847cc3807b0c6ed511e0d83e0d560e9f07ec44))
...
- **Release Process Improvements** - Enhanced automation and quality gates
  ([`a52ce1c`](https://github.com/adrianx26/memopad/commit/a52ce1c8605ec2cd450d1f909154172cbc30faa2))
...
- **Docker Users**: Container images now served from `ghcr.io/adrianx26/memopad` instead of Docker Hub
...
# Docker (new registry)
docker pull ghcr.io/adrianx26/memopad:latest
```
...
- **Custom Entity Types** - Support for custom entity types in write_note
  ([`7789864`](https://github.com/adrianx26/memopad/commit/77898644933589c2da9bdd60571d54137a5309ed))
...
- **#139**: Fix "UNIQUE constraint failed: entity.permalink" database error
  ([`c6215fd`](https://github.com/adrianx26/memopad/commit/c6215fd819f9564ead91cf3a950f855241446096))
...
- **Database Migration Performance** - Eliminate redundant migration initialization
  ([`84d2aaf`](https://github.com/adrianx26/memopad/commit/84d2aaf6414dd083af4b0df73f6c8139b63468f6))
...
- **User Experience** - Correct spelling error in continue_conversation prompt
  ([`b4c26a6`](https://github.com/adrianx26/memopad/commit/b4c26a613379e6f2ba655efe3d7d8d40c27999e5))
...
- **Website Updates** - Add new website and community links to README
  ([`3fdce68`](https://github.com/adrianx26/memopad/commit/3fdce683d7ad8b6f4855d7138d5ff2136d4c07bc))

- **Project Documentation** - Update README.md and CLAUDE.md with latest project information
  ([`782cb2d`](https://github.com/adrianx26/memopad/commit/782cb2df28803482d209135a054e67cc32d7363e))
...
- **CLI**: Fixed  `memopad project` project management commands that were  not working in v0.13.0 (#129)
...
- Renamed `memopad project sync` command to `memopad project sync-config` for clarity
...
**What Changes:**
- Database location: Moved to `~/.memopad/memory.db` (unified across projects)
- Configuration: Projects defined in `~/.memopad/config.json` are synced with database
...
- Add extra logic for permalink generation with mixed Latin unicode and Chinese characters
  ([`73ea91f`](https://github.com/adrianx26/memopad/commit/73ea91fe0d1f7ab89b99a1b691d59fe608b7fcbb))



- Modify recent_activity args to be strings instead of enums
  ([`3c1cc34`](https://github.com/adrianx26/memopad/commit/3c1cc346df519e703fae6412d43a92c7232c6226))
...
- Utf8 for all file reads/write/open instead of default platform encoding
  ([#91](https://github.com/adrianx26/memopad/pull/91),
  [`2934176`](https://github.com/adrianx26/memopad/commit/29341763318408ea8f1e954a41046c4185f836c6))
...
- Run migrations and sync when starting mcp
  ([#88](https://github.com/adrianx26/memopad/pull/88),
  [`78a3412`](https://github.com/adrianx26/memopad/commit/78a3412bcff83b46e78e26f8b9fce42ed9e05991))
...
- [bug] `#` character accumulation in markdown frontmatter tags prop
  ([#79](https://github.com/adrianx26/memopad/pull/79),
  [`6c19c9e`](https://github.com/adrianx26/memopad/commit/6c19c9edf5131054ba201a109b37f15c83ef150c))

- [bug] Cursor has errors calling search tool
  ([#78](https://github.com/adrianx26/memopad/pull/78),
  [`9d581ce`](https://github.com/adrianx26/memopad/commit/9d581cee133f9dde4a0a85118868227390c84161))

- [bug] Some notes never exit "modified" status
  ([#77](https://github.com/adrianx26/memopad/pull/77),
  [`7930ddb`](https://github.com/adrianx26/memopad/commit/7930ddb2919057be30ceac8c4c19da6aaa1d3e92))

- [bug] write_note Tool Fails to Update Existing Files in Some Situations.
  ([#80](https://github.com/adrianx26/memopad/pull/80),
  [`9bff1f7`](https://github.com/adrianx26/memopad/commit/9bff1f732e71bc60f88b5c2ce3db5a2aa60b8e28))

- Set default mcp log level to ERROR
  ([#81](https://github.com/adrianx26/memopad/pull/81),
  [`248214c`](https://github.com/adrianx26/memopad/commit/248214cb114a269ca60ff6398e382f9e2495ad8e))

- Write_note preserves frontmatter fields in content
  ([#84](https://github.com/adrianx26/memopad/pull/84),
  [`3f4d9e4`](https://github.com/adrianx26/memopad/commit/3f4d9e4d872ebc0ed719c61b24d803c14a9db5e6))

### Documentation

- Add VS Code instructions to README
  ([#76](https://github.com/adrianx26/memopad/pull/76),
  [`43cbb7b`](https://github.com/adrianx26/memopad/commit/43cbb7b38cc0482ac0a41b6759320e3588186e43))

- Updated xxx links to be https
  ([#69](https://github.com/adrianx26/memopad/pull/69),
  [`40ea28b`](https://github.com/adrianx26/memopad/commit/40ea28b0bfc60012924a69ecb76511daa4c7d133))

### Features

- Add watch to mcp process ([#83](https://github.com/adrianx26/memopad/pull/83),
  [`00c8633`](https://github.com/adrianx26/memopad/commit/00c8633cfcee75ff640ff8fe81dafeb956281a94))

- Permalink enhancements ([#82](https://github.com/adrianx26/memopad/pull/82),
  [`617e60b`](https://github.com/adrianx26/memopad/commit/617e60bda4a590678a5f551f10a73e7b47e3b13e))
...
- Just delete db for reset db instead of using migrations.
  ([#65](https://github.com/adrianx26/memopad/pull/65),
  [`0743ade`](https://github.com/adrianx26/memopad/commit/0743ade5fc07440f95ecfd816ba7e4cfd74bca12))



- Make logs for each process - mcp, sync, cli
  ([#64](https://github.com/adrianx26/memopad/pull/64),
  [`f1c9570`](https://github.com/adrianx26/memopad/commit/f1c95709cbffb1b88292547b0b8f29fcca22d186))
...
- Update broken "Multiple Projects" link in README.md
  ([#55](https://github.com/adrianx26/memopad/pull/55),
  [`3c68b7d`](https://github.com/adrianx26/memopad/commit/3c68b7d5dd689322205c67637dca7d188111ee6b))

### Features

- Add bm command alias for memopad
  ([#67](https://github.com/adrianx26/memopad/pull/67),
  [`069c0a2`](https://github.com/adrianx26/memopad/commit/069c0a21c630784e1bf47d2b7de5d6d1f6fadd7a))



- Rename search tool to search_notes
  ([#66](https://github.com/adrianx26/memopad/pull/66),
  [`b278276`](https://github.com/adrianx26/memopad/commit/b27827671dc010be3e261b8b221aca6b7f836661))
...
- Make set_default_project also activate project for current session to fix #37
  ([`cbe72be`](https://github.com/adrianx26/memopad/commit/cbe72be10a646c0b03931bb39aff9285feae47f9))

This change makes the 'memopad project default <name>' command both: 1. Set the default project
...
- Make set_default_project also activate project for current session to fix #37
  ([`46c4fd2`](https://github.com/adrianx26/memopad/commit/46c4fd21645b109af59eb2a0201c7bd849b34a49))
...
- Move ai_assistant_guide.md into package resources to fix #39
  ([`390ff9d`](https://github.com/adrianx26/memopad/commit/390ff9d31ccee85bef732e8140b5eeecd7ee176f))
...
- Move ai_assistant_guide.md into package resources to fix #39
  ([`cc2cae7`](https://github.com/adrianx26/memopad/commit/cc2cae72c14b380f78ffeb67c2261e4dbee45faf))
...
- Preserve custom frontmatter fields when updating notes
  ([`78f234b`](https://github.com/adrianx26/memopad/commit/78f234b1806b578a0a833e8ee4184015b7369a97))
...
- Preserve custom frontmatter fields when updating notes
  ([`e716946`](https://github.com/adrianx26/memopad/commit/e716946b4408d017eca4be720956d5a210b4e6b1))
...
- Remove duplicate code in entity_service.py from bad merge
  ([`681af5d`](https://github.com/adrianx26/memopad/commit/681af5d4505dadc40b4086630f739d76bac9201d))
...
- Add help docs to mcp cli tools
  ([`731b502`](https://github.com/adrianx26/memopad/commit/731b502d36cec253d114403d73b48fab3c47786e))



- Add mcp badge, update cli reference, llms-install.md
  ([`b26afa9`](https://github.com/adrianx26/memopad/commit/b26afa927f98021246cd8b64858e57333595ea90))



- Update CLAUDE.md ([#33](https://github.com/adrianx26/memopad/pull/33),
  [`dfaf0fe`](https://github.com/adrianx26/memopad/commit/dfaf0fea9cf5b97d169d51a6276ec70162c21a7e))
...
- Move project stats into projct subcommand
  ([`2a881b1`](https://github.com/adrianx26/memopad/commit/2a881b1425c73947f037fbe7ac5539c015b62526))
...
- Ai_resource_guide.md path
  ([`da97353`](https://github.com/adrianx26/memopad/commit/da97353cfc3acc1ceb0eca22ac6af326f77dc199))



- Ai_resource_guide.md path
  ([`c4732a4`](https://github.com/adrianx26/memopad/commit/c4732a47b37dd2e404139fb283b65556c81ce7c9))

- Ai_resource_guide.md path
  ([`2e9d673`](https://github.com/adrianx26/memopad/commit/2e9d673e54ad6a63a971db64f01fc2f4e59c2e69))



- Don't sync *.tmp files on watch ([#31](https://github.com/adrianx26/memopad/pull/31),
  [`6b110b2`](https://github.com/adrianx26/memopad/commit/6b110b28dd8ba705ebfc0bcb41faf2cb993da2c3))
...
- Drop search_index table on db reindex
  ([`31cca6f`](https://github.com/adrianx26/memopad/commit/31cca6f913849a0ab8fc944803533e3072e9ef88))



- Improve utf-8 support for file reading/writing
  ([#32](https://github.com/adrianx26/memopad/pull/32),
  [`eb5e4ec`](https://github.com/adrianx26/memopad/commit/eb5e4ec6bd4d2fe757087be030d867f4ca1d38ba))
...
- Remove logfire
  ([`9bb8a02`](https://github.com/adrianx26/memopad/commit/9bb8a020c3425a02cb3a88f6f02adcd281bccee2))
...
- Add glama badge. Fix typos in README.md
  ([#28](https://github.com/adrianx26/memopad/pull/28),
  [`9af913d`](https://github.com/adrianx26/memopad/commit/9af913da4fba7bb4908caa3f15f2db2aa03777ec))



- Update CLAUDE.md with GitHub integration capabilities
  ([#25](https://github.com/adrianx26/memopad/pull/25),
  [`fea2f40`](https://github.com/adrianx26/memopad/commit/fea2f40d1b54d0c533e6d7ee7ce1aa7b83ad9a47))
...
- Add Smithery integration for easier installation
  ([#24](https://github.com/adrianx26/memopad/pull/24),
  [`eb1e7b6`](https://github.com/adrianx26/memopad/commit/eb1e7b6088b0b3dead9c104ee44174b2baebf417))
...
- Pre beta prep ([#20](https://github.com/adrianx26/memopad/pull/20),
  [`6a4bd54`](https://github.com/adrianx26/memopad/commit/6a4bd546466a45107007b5000276b6c9bb62ef27))
...
- Update README.md and CLAUDE.md
  ([`182ec78`](https://github.com/adrianx26/memopad/commit/182ec7835567fc246798d9b4ad121b2f85bc6ade))

### Features

- Add project_info tool ([#19](https://github.com/adrianx26/memopad/pull/19),
  [`d2bd75a`](https://github.com/adrianx26/memopad/commit/d2bd75a949cc4323cb376ac2f6cb39f47c78c428))



- Beta work ([#17](https://github.com/adrianx26/memopad/pull/17),
  [`e6496df`](https://github.com/adrianx26/memopad/commit/e6496df595f3cafde6cc836384ee8c60886057a5))
...
- Implement boolean search ([#18](https://github.com/adrianx26/memopad/pull/18),
  [`90d5754`](https://github.com/adrianx26/memopad/commit/90d5754180beaf4acd4be38f2438712555640b49))
...
- Formatting
  ([`93cc637`](https://github.com/adrianx26/memopad/commit/93cc6379ebb9ecc6a1652feeeecbf47fc992d478))

- Refactor logging setup
  ([`f4b703e`](https://github.com/adrianx26/memopad/commit/f4b703e57f0ddf686de6840ff346b8be2be499ad))

### Features

- Add enhanced prompts and resources
  ([#15](https://github.com/adrianx26/memopad/pull/15),
  [`093dab5`](https://github.com/adrianx26/memopad/commit/093dab5f03cf7b090a9f4003c55507859bf355b0))
...
- Add new `canvas` tool to create json canvas files in obsidian.
  ([#14](https://github.com/adrianx26/memopad/pull/14),
  [`0d7b0b3`](https://github.com/adrianx26/memopad/commit/0d7b0b3d7ede7555450ddc9728951d4b1edbbb80))
...
- Incremental sync on watch ([#13](https://github.com/adrianx26/memopad/pull/13),
  [`37a01b8`](https://github.com/adrianx26/memopad/commit/37a01b806d0758029d34a862e76d44c7e5d538a5))
...
- Add logfire instrumentation to tools
  ([`3e8e3e8`](https://github.com/adrianx26/memopad/commit/3e8e3e8961eae2e82839746e28963191b0aef0a0))

- Add logfire spans to cli
  ([`00d23a5`](https://github.com/adrianx26/memopad/commit/00d23a5ee15ddac4ea45e702dcd02ab9f0509276))

- Add logfire spans to cli
  ([`812136c`](https://github.com/adrianx26/memopad/commit/812136c8c22ad191d14ff32dcad91aae076d4120))

- Search query pagination params
  ([`bc9ca07`](https://github.com/adrianx26/memopad/commit/bc9ca0744ffe4296d7d597b4dd9b7c73c2d63f3f))

### Chores

- Fix tests
  ([`57984aa`](https://github.com/adrianx26/memopad/commit/57984aa912625dcde7877afb96d874c164af2896))

- Remove unused tests
  ([`2c8ed17`](https://github.com/adrianx26/memopad/commit/2c8ed1737d6769fe1ef5c96f8a2bd75b9899316a))

### Features

- Add cli commands for mcp tools
  ([`f5a7541`](https://github.com/adrianx26/memopad/commit/f5a7541da17e97403b7a702720a05710f68b223a))

- Add pagination to build_context and recent_activity
  ([`0123544`](https://github.com/adrianx26/memopad/commit/0123544556513af943d399d70b849b142b834b15))

- Add pagination to read_notes
  ([`02f8e86`](https://github.com/adrianx26/memopad/commit/02f8e866923d5793d2620076c709c920d99f2c4f))
...
- Re-add sync status console on watch
  ([`66b57e6`](https://github.com/adrianx26/memopad/commit/66b57e682f2e9c432bffd4af293b0d1db1d3469b))

### Features

- Configure logfire telemetry ([#12](https://github.com/adrianx26/memopad/pull/12),
  [`6da1438`](https://github.com/adrianx26/memopad/commit/6da143898bd45cdab8db95b5f2b75810fbb741ba))
...
- Return semantic info in markdown after write_note
  ([#11](https://github.com/adrianx26/memopad/pull/11),
  [`0689e7a`](https://github.com/adrianx26/memopad/commit/0689e7a730497827bf4e16156ae402ddc5949077))
...
- Re do enhanced read note format ([#10](https://github.com/adrianx26/memopad/pull/10),
  [`39bd5ca`](https://github.com/adrianx26/memopad/commit/39bd5ca08fd057220b95a8b5d82c5e73a1f5722b))
...
- Fix alemic config
  ([`71de8ac`](https://github.com/adrianx26/memopad/commit/71de8acfd0902fc60f27deb3638236a3875787ab))

- More alembic fixes
  ([`30cd74e`](https://github.com/adrianx26/memopad/commit/30cd74ec95c04eaa92b41b9815431f5fbdb46ef8))
...
- Import chatgpt conversation data ([#9](https://github.com/adrianx26/memopad/pull/9),
  [`56f47d6`](https://github.com/adrianx26/memopad/commit/56f47d6812982437f207629e6ac9a82e0e56514e))

Co-authored-by: phernandez <phernandez@xxx>

- Import claude.ai data ([#8](https://github.com/adrianx26/memopad/pull/8),
  [`a15c346`](https://github.com/adrianx26/memopad/commit/a15c346d5ebd44344b76bad877bb4d1073fcbc3b))

Import Claude.ai conversation and project data to memopad Markdown format.
...
- Refactor db schema migrate handling
  ([`ca632be`](https://github.com/adrianx26/memopad/commit/ca632beb6fed5881f4d8ba5ce698bb5bc681e6aa))
...
- Fix osx installer github action
  ([`65ebe5d`](https://github.com/adrianx26/memopad/commit/65ebe5d19491e5ff047c459d799498ad5dd9cd1a))

- Handle memory:// url format in read_note tool
  ([`e080373`](https://github.com/adrianx26/memopad/commit/e0803734e69eeb6c6d7432eea323c7a264cb8347))

- Remove create schema from init_db
  ([`674dd1f`](https://github.com/adrianx26/memopad/commit/674dd1fd47be9e60ac17508476c62254991df288))

### Features

- Set version in var, output version at startup
  ([`a91da13`](https://github.com/adrianx26/memopad/commit/a91da1396710e62587df1284da00137d156fc05e))
...
- Fix installer artifact
  ([`8de84c0`](https://github.com/adrianx26/memopad/commit/8de84c0221a1ee32780aa84dac4d3ea60895e05c))
...
- Get app artifact for installer
  ([`fe8c3d8`](https://github.com/adrianx26/memopad/commit/fe8c3d87b003166252290a87cbe958301cccf797))
...
- Don't zip app on release
  ([`8664c57`](https://github.com/adrianx26/memopad/commit/8664c57bb331d7f3f7e0239acb5386c7a3c6144e))
...
- Fix app zip in installer release
  ([`8fa197e`](https://github.com/adrianx26/memopad/commit/8fa197e2ec8a1b6caaf6dbb39c3c6626bba23e2e))
...
- Debug inspect build on ci
  ([`1d6054d`](https://github.com/adrianx26/memopad/commit/1d6054d30a477a4e6a5d6ac885632e50c01945d3))
...
- Debug installer ci
  ([`dab9573`](https://github.com/adrianx26/memopad/commit/dab957314aec9ed0e12abca2265552494ae733a2))
...
- Refactor release.yml installer
  ([`a152657`](https://github.com/adrianx26/memopad/commit/a15265783e47c22d8c7931396281d023b3694e27))

- Try using symlinks in installer build
  ([`8dd923d`](https://github.com/adrianx26/memopad/commit/8dd923d5bc0587276f92b5f1db022ad9c8687e45))
...
- Fix cx_freeze options for installer
  ([`854cf83`](https://github.com/adrianx26/memopad/commit/854cf8302e2f83578030db05e29b8bdc4348795a))
...
- Ci installer app fix #37
  ([`2e215fe`](https://github.com/adrianx26/memopad/commit/2e215fe83ca421b921186c7f1989dc2cb5cca278))
...
- Fix build on github ci for app installer
  ([`29a2594`](https://github.com/adrianx26/memopad/commit/29a259421a0ccb10cfa68e3707eaa506ad5e55c0))
...
- Fix installer on ci, maybe
  ([`edbc04b`](https://github.com/adrianx26/memopad/commit/edbc04be601d234bb1f5eb3ba24d6ad55244b031))
...
- Try to fix installer ci
  ([`230738e`](https://github.com/adrianx26/memopad/commit/230738ee9c110c0509e0a09cb0e101a92cfcb729))
...
- Bump project patch version
  ([`01d4672`](https://github.com/adrianx26/memopad/commit/01d46727b40c24b017ea9db4b741daef565ac73e))

- Fix installer setup.py change ci to use make
  ([`3e78fcc`](https://github.com/adrianx26/memopad/commit/3e78fcc2c208d83467fe7199be17174d7ffcad1a))
...
- Refix vitual env in installer build
  ([`052f491`](https://github.com/adrianx26/memopad/commit/052f491fff629e8ead629c9259f8cb46c608d584))
...
- Workaround unsigned app
  ([`41d4d81`](https://github.com/adrianx26/memopad/commit/41d4d81c1ad1dc2923ba0e903a57454a0c8b6b5c))
...
- Fix path to intaller app artifact
  ([`53d220d`](https://github.com/adrianx26/memopad/commit/53d220df585561f9edd0d49a9e88f1d4055059cf))
...
- Activate vitualenv in installer build
  ([`d4c8293`](https://github.com/adrianx26/memopad/commit/d4c8293687a52eaf3337fe02e2f7b80e4cc9a1bb))

- Trigger installer build on release
  ([`f11bf78`](https://github.com/adrianx26/memopad/commit/f11bf78f3f600d0e1b01996cf8e1f9c39e3dd218))
...
- Build installer via github action ([#7](https://github.com/adrianx26/memopad/pull/7),
  [`7c381a5`](https://github.com/adrianx26/memopad/commit/7c381a59c962053c78da096172e484f28ab47e96))
...
- Fix installer for mac
  ([`dde9ff2`](https://github.com/adrianx26/memopad/commit/dde9ff228b72852b5abc58faa1b5e7c6f8d2c477))

- Remove unused FileChange dataclass
  ([`eb3360c`](https://github.com/adrianx26/memopad/commit/eb3360cc221f892b12a17137ae740819d48248e8))

- Update uv installer url
  ([`2f9178b`](https://github.com/adrianx26/memopad/commit/2f9178b0507b3b69207d5c80799f2d2f573c9a04))
...
- Create virtual env in test workflow
  ([`8092e6d`](https://github.com/adrianx26/memopad/commit/8092e6d38d536bfb6f93c3d21ea9baf1814f9b0a))

- Fix permalink uniqueness violations on create/update/sync
  ([`135bec1`](https://github.com/adrianx26/memopad/commit/135bec181d9b3d53725c8af3a0959ebc1aa6afda))

- Fix recent activity bug
  ([`3d2c0c8`](https://github.com/adrianx26/memopad/commit/3d2c0c8c32fcfdaf70a1f96a59d8f168f38a1aa9))

- Install fastapi deps after removing basic-foundation
  ([`51a741e`](https://github.com/adrianx26/memopad/commit/51a741e7593a1ea0e5eb24e14c70ff61670f9663))

- Recreate search index on db reset
  ([`1fee436`](https://github.com/adrianx26/memopad/commit/1fee436bf903a35c9ebb7d87607fc9cc9f5ff6e7))

- Remove basic-foundation from deps
  ([`b8d0c71`](https://github.com/adrianx26/memopad/commit/b8d0c7160f29c97cdafe398a7e6a5240473e0c89))

- Run tests via uv
  ([`4eec820`](https://github.com/adrianx26/memopad/commit/4eec820a32bc059a405e2f4dac4c73b245ca4722))

### Chores

- Rename import tool
  ([`af6b7dc`](https://github.com/adrianx26/memopad/commit/af6b7dc40a55eaa2aa78d6ea831e613851081d52))

### Features

- Add memory-json importer, tweak observation content
  ([`3484e26`](https://github.com/adrianx26/memopad/commit/3484e26631187f165ee6eb85517e94717b7cf2cf))
...
- Fix versioning for 0.0.1 release
  ([`ba1e494`](https://github.com/adrianx26/memopad/commit/ba1e494ed1afbb7af3f97c643126bced425da7e0))
...
- Remove basic-foundation src ref in pyproject.toml
  ([`29fce8b`](https://github.com/adrianx26/memopad/commit/29fce8b0b922d54d7799bf2534107ee6cfb961b8))
