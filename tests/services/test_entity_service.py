...
async def test_create_entity_from_markdown_error_handling(
    ...
    from memopad.services.exceptions import EntityCreationError
...
async def test_move_entity_success(
    ...
    app_config = MemoPadConfig(update_permalinks_on_move=False)
...
async def test_move_entity_with_permalink_update(
    ...
    app_config = MemoPadConfig(update_permalinks_on_move=True)
...
async def test_move_entity_with_null_permalink_generates_permalink(
    ...
    from memopad.schemas.response import EntityResponse
