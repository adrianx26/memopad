...
async def test_create_entity_with_permalinks_disabled(
    ...
    app_config = MemoPadConfig(disable_permalinks=True)
...
async def test_update_entity_with_permalinks_disabled(
    ...
    app_config_enabled = MemoPadConfig(disable_permalinks=False)
    ...
    app_config_disabled = MemoPadConfig(disable_permalinks=True)
...
async def test_move_entity_with_permalinks_disabled(
    ...
    # First create with permalinks enabled
    app_config = MemoPadConfig(disable_permalinks=False, update_permalinks_on_move=True)
    entity_service = EntityService(
        entity_parser=entity_parser,
        entity_repository=entity_repository,
        observation_repository=observation_repository,
    ...
    app_config_disabled = MemoPadConfig(disable_permalinks=True, update_permalinks_on_move=True)
