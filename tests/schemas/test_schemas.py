...
from memopad.schemas.base import to_snake_case, TimeFrame, parse_timeframe, validate_timeframe
...
def test_permalink_generation():
    ...
    test_cases = [
        ({"title": "BasicMemory", "directory": "test"}, "test/memopad"),
...
class TestObservationContentLength:
    ...
    def test_observation_accepts_long_content(self):
        ...
        from memopad.schemas.base import Observation
