...
import pytest
from memopad.project_resolver import (
    ProjectResolver,
    ResolvedProject,
    ResolutionMode,
)
...
class TestProjectResolver:
    ...
    def test_local_mode_env_constraint_priority(self, monkeypatch):
        ...
        monkeypatch.setenv("MEMOPAD_MCP_PROJECT", "constrained-project")
    ...
    def test_from_env_without_env_var(self, monkeypatch):
        """from_env without MEMOPAD_MCP_PROJECT set."""
    ...
    def test_from_env_with_env_var(self, monkeypatch):
        """from_env with MEMOPAD_MCP_PROJECT set."""
