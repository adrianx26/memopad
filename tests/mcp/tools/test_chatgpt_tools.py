...
from memopad.mcp.tools import write_note
from memopad.schemas.search import SearchResponse, SearchResult, SearchItemType
...
async def test_search_successful_results(client, test_project):
    ...
    from memopad.mcp.tools.chatgpt_tools import search
...
async def test_search_with_error_response(monkeypatch, client, test_project):
    ...
    import memopad.mcp.tools.chatgpt_tools as chatgpt_tools
...
async def test_fetch_successful_document(client, test_project):
    ...
    from memopad.mcp.tools.chatgpt_tools import fetch
...
def test_format_search_results_for_chatgpt():
    ...
    from memopad.mcp.tools.chatgpt_tools import _format_search_results_for_chatgpt
...
def test_format_document_for_chatgpt():
    ...
    from memopad.mcp.tools.chatgpt_tools import _format_document_for_chatgpt
