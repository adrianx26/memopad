...
from memopad.mcp.async_client import _force_local_mode
...
class TestForceLocalMode:
    ...
    def test_returns_true_for_1(self):
        ...
        os.environ["MEMOPAD_FORCE_LOCAL"] = "1"
        try:
            assert _force_local_mode() is True
        finally:
            os.environ.pop("MEMOPAD_FORCE_LOCAL", None)
    ...
    def test_returns_true_for_yes(self):
        ...
        os.environ["MEMOPAD_FORCE_LOCAL"] = "yes"
        try:
            assert _force_local_mode() is True
        finally:
            os.environ.pop("MEMOPAD_FORCE_LOCAL", None)
    ...
    def test_returns_false_for_false(self):
        ...
        os.environ["MEMOPAD_FORCE_LOCAL"] = "false"
        try:
            assert _force_local_mode() is False
        finally:
            os.environ.pop("MEMOPAD_FORCE_LOCAL", None)
    ...
    def test_returns_false_for_0(self):
        ...
        os.environ["MEMOPAD_FORCE_LOCAL"] = "0"
        try:
            assert _force_local_mode() is False
        finally:
            os.environ.pop("MEMOPAD_FORCE_LOCAL", None)
    ...
    def test_returns_false_for_empty(self):
        ...
        os.environ["MEMOPAD_FORCE_LOCAL"] = ""
        try:
            assert _force_local_mode() is False
        finally:
            os.environ.pop("MEMOPAD_FORCE_LOCAL", None)
    ...
    def test_returns_false_for_random_string(self):
        ...
        os.environ["MEMOPAD_FORCE_LOCAL"] = "random"
        try:
            assert _force_local_mode() is False
        finally:
            os.environ.pop("MEMOPAD_FORCE_LOCAL", None)
