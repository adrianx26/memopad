...
from memopad.mcp.clients import (
    KnowledgeClient,
    SearchClient,
    MemoryClient,
    DirectoryClient,
...
class TestKnowledgeClient:
    ...
    async def test_create_entity(self, monkeypatch):
        ...
        from memopad.mcp.clients import knowledge as knowledge_mod
...
class TestSearchClient:
    ...
    async def test_search(self, monkeypatch):
        ...
        from memopad.mcp.clients import search as search_mod
...
class TestMemoryClient:
    ...
    async def test_build_context(self, monkeypatch):
        ...
        from memopad.mcp.clients import memory as memory_mod
...
class TestDirectoryClient:
    ...
    async def test_list(self, monkeypatch):
        ...
        from memopad.mcp.clients import directory as directory_mod
...
class TestResourceClient:
    ...
    async def test_read(self, monkeypatch):
        ...
        from memopad.mcp.clients import resource as resource_mod
...
class TestProjectClient:
    ...
    async def test_list_projects(self, monkeypatch):
        ...
        from memopad.mcp.clients import project as project_mod
