...
from memopad.mcp.tools.search import search_notes, _format_search_error_response
from memopad.schemas.search import SearchResponse
...
class TestSearchToolErrorHandling:
    ...
    async def test_search_notes_exception_handling(self, monkeypatch):
        ...
        search_mod = importlib.import_module("memopad.mcp.tools.search")
