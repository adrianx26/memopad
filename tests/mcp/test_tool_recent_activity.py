...
from memopad.mcp.tools import recent_activity
...
async def test_recent_activity_discovery_mode_multiple_active_projects(
    ...
    from memopad.mcp.tools import create_memory_project, write_note
...
def test_recent_activity_format_relative_time_and_truncate_helpers():
    ...
    recent_activity_module = importlib.import_module("memopad.mcp.tools.recent_activity")
