...
from memopad.mcp.tools import write_note, read_note
from memopad.schemas.search import SearchResponse, SearchResult, SearchItemType
from memopad.utils import normalize_newlines
...
async def test_read_note_title_search_fallback_fetches_by_permalink(monkeypatch, app, test_project):
    ...
    import importlib
    from memopad.schemas.memory import memory_url_path

    clients_mod = importlib.import_module("memopad.mcp.clients")
...
async def test_read_note_returns_related_results_when_text_search_finds_matches(
    ...
    read_note_module = importlib.import_module("memopad.mcp.tools.read_note")
    clients_mod = importlib.import_module("memopad.mcp.clients")
    OriginalKnowledgeClient = clients_mod.KnowledgeClient
