...
from memopad.config import MemoPadConfig, CloudProjectConfig, ConfigManager
...
class TestConfigManager:
    ...
    def test_add_cloud_project_to_existing_config(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            initial_config = MemoPadConfig(projects={"main": str(temp_path / "main")})
    ...
    def test_backward_compatibility_loading_config_without_cloud_projects(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            import memopad.config

            memopad.config._CONFIG_CACHE = None
