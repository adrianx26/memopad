...
from memopad.cli.commands.cloud.api_client import (
    CloudAPIError,
...
class TestLoginCommand:
    ...
    def test_login_without_subscription_shows_error(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "memopad.cli.commands.cloud.core_commands.CLIAuth",
            lambda **_kwargs: _StubAuth(login_ok=True),
        )
        monkeypatch.setattr(
            "memopad.cli.commands.cloud.core_commands.get_cloud_config",
        ...
        monkeypatch.setattr(
            "memopad.cli.commands.cloud.core_commands.make_api_request",
    ...
    def test_login_with_subscription_succeeds(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "memopad.cli.commands.cloud.core_commands.ConfigManager",
            _StubConfigManager,
        )
