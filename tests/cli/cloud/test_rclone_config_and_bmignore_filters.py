...
from memopad.cli.commands.cloud.bisync_commands import convert_bmignore_to_rclone_filters
from memopad.cli.commands.cloud.rclone_config import (
    configure_rclone_remote,
    get_rclone_config_path,
)
from memopad.ignore_utils import get_bmignore_path
...
def test_configure_rclone_remote_writes_config_and_backs_up_existing(config_home):
    ...
    assert remote == "memopad-cloud"

    # Config file updated
    text = cfg_path.read_text(encoding="utf-8")
    assert "[memopad-cloud]" in text
