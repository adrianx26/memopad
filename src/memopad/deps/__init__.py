"""Dependency injection for memopad.
...
from memopad.deps.config import (
    get_app_config,
    AppConfigDep,
)

from memopad.deps.db import (
    get_engine_factory,
    EngineFactoryDep,
    get_session_maker,
    SessionMakerDep,
...
from memopad.deps.repositories import (
    ...
    get_entity_alias_repository_v2,
    EntityAliasRepositoryV2Dep,
    get_entity_alias_repository_v2_external,
    ...
    get_observation_schema_repository,
    ObservationSchemaRepositoryDep,
    get_observation_schema_repository_v2,
    ObservationSchemaRepositoryV2Dep,
    get_observation_schema_repository_v2_external,
...
from memopad.deps.services import (
    ...
    ConflictServiceDep,
    ConflictServiceV2Dep,
    get_conflict_service_v2,
    get_conflict_service_v2_external,
    ConflictServiceV2ExternalDep,
    get_schema_service,
    SchemaServiceDep,
    get_schema_service_v2,
    SchemaServiceV2Dep,
    get_schema_service_v2_external,
    SchemaServiceV2ExternalDep,
    get_entity_service,
    EntityServiceDep,
