...
class WatchService:
    def __init__(
        ...
        self._ignore_matcher_cache: dict[Path, IgnoreMatcher] = {}
    ...
    def _get_ignore_matcher(self, project_path: Path) -> IgnoreMatcher:
        ...
        if project_path not in self._ignore_matcher_cache:
            patterns = load_gitignore_patterns(project_path)
            self._ignore_matcher_cache[project_path] = IgnoreMatcher(patterns)
        return self._ignore_matcher_cache[project_path]
    ...
    async def run(self):  # pragma: no cover
        ...
        try:
            while self.state.running:
                ...
                self._ignore_matcher_cache.clear()
