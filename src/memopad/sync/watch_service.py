...
from memopad.ignore_utils import IgnoreMatcher, load_gitignore_patterns
                    ...
                    if self.is_project_path(project, path):
                        ...
                        try:
                            ...
                            if matcher.match(relative_path):
                                logger.trace(
                                    f"Ignoring watched file change: {relative_path}"
                                )
                                continue
                        except ValueError:
                            # if we can't get relative path, we don't ignore it here
                            pass
