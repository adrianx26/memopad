...
from memopad.schemas.importer import ChatImportResult
from memopad.importers.utils import clean_filename, format_timestamp
...
class ChatGPTImporter(Importer[ChatImportResult]):
    ...
    async def import_data(
        ...
        Args:
            source_data: Parsed/deserialized ChatGPT export — an iterable of
