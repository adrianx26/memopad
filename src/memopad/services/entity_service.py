...
class EntityService(BaseService[EntityModel]):
    ...
    async def resolve_permalink(
        ...
        # Skip cache if markdown provides explicit permalink that might differ
        has_explicit_permalink = markdown and markdown.frontmatter.permalink
        if not has_explicit_permalink and cache_key in self._permalink_cache:
