...
async def initialize_database(app_config: MemoPadConfig) -> None:
...
async def reconcile_projects_with_config(app_config: MemoPadConfig):
...
async def initialize_file_sync(
    ...
    # delay import
    from memopad.sync import WatchService
    ...
    constrained_project = os.environ.get("MEMOPAD_MCP_PROJECT")
...
def ensure_initialization(app_config: MemoPadConfig) -> None:
