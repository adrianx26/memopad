...
from memopad.mcp.prompts import continue_conversation
from memopad.mcp.prompts import recent_activity
from memopad.mcp.prompts import search
from memopad.mcp.prompts import ai_assistant_guide
