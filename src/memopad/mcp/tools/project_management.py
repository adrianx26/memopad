...
async def list_memory_projects(context: Context | None = None) -> str:
    ...
    async with get_client() as client:
        ...
        from memopad.mcp.clients import ProjectClient
