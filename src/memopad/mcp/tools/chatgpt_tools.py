"""ChatGPT-compatible MCP tools for Memopad.

These adapters expose Memopad's search/fetch functionality using the exact
...
from memopad.mcp.tools.search import search_notes
