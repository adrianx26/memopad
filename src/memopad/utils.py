...
def normalize_project_path(path: str) -> str:
    ...
    Args:
        path: Project path (e.g., "/app/data/memopad-llc" or "C:\\Users\\...")

    Returns:
        Normalized path (e.g., "/memopad-llc" or "C:\\Users\\...")
...
def setup_logging(
    ...
    if structured_context:
        logger.configure(
            extra={
                "tenant_id": os.getenv("MEMOPAD_TENANT_ID", "local"),
