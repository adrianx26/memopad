...
- MEMOPAD_FORCE_LOCAL: When "true", forces local ASGI transport
- These are checked in memopad.mcp.async_client.get_client()
"""
...
def force_routing(local: bool = False, cloud: bool = False) -> Generator[None, None, None]:
    ...
    original_force_local = os.environ.get("MEMOPAD_FORCE_LOCAL")
    ...
    try:
        ...
        if original_force_local is None:
            ...
            os.environ["MEMOPAD_FORCE_LOCAL"] = original_force_local
