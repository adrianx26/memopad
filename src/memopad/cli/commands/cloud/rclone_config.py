...
Uses a single "memopad-cloud" remote for all operations.
"""
...
def configure_rclone_remote(
    ...
    """Configure single rclone remote named 'memopad-cloud'.
