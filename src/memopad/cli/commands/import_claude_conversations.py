"""Import command for memopad CLI to import chat data from conversations2.json format."""
...
import typer
from memopad.cli.app import claude_app
...
def import_claude(
    ...
    After importing, run 'memopad sync' to index the new files.
    """
    ...
    try:
        ...
        console.print("\nRun 'memopad sync' to index the new files.")
